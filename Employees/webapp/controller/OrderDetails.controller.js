        ...
        return Controller.extend("logaligroup.Employees.controller.OrderDetails", {
            ...
            factoryOrderDetails: function (listId, oContext) {
                ...
                if (contextObject.Quantity <= unitsInStock) {
                    var objectListIntem = new sap.m.ObjectListItem({
                    ...
                    var customListItem = new sap.m.CustomListItem({
                        content: [
                            new sap.m.Bar({
                                ...
                                contentMiddle: new sap.m.ObjectStatus({ text: "{i18n>availibleStock} {odataNorthwind>/Products(" + contextObject.ProductID + ")/UnitsInStock}", state: "Error" }),
            ...
            onSaveSignature: function (oEvent) {
                ...
                if (!signature.isFill()) {
                    ...
                    this.getView().getModel("incidenceModel").create("/SignatureSet", body, {
                        success: function () {
                            MessageBox.information(oResourceBundle.getText("signatureSavedOK"))
                        },
                        error: function (error) {
                            MessageBox.error(oResourceBundle.getText("signatureSavedKO"))
                        }
                    });
                }
            },
